...
class ModalDayOff extends Component {
  state = {
    hasPast: false,
  ...
  render() {
    ...
    return (
      <Modal
            ...
            <Col className="center"
              ...
              raised="true"
                ...
                onClick={() => this.props.sendCancelThenDelete(this.props.id, this.props.email, this.props.firstName,
                  this.props.lastName, this.props.time, this.props.date, this.props.slot, this.props.service, this.props.EmployeeId, this.props.CustomerId)}
                type="button"
        ...
        trigger={<Col  s={3}  ><Button raised="true" small waves='light' tooltip="Delete"  className="tooltipped red deleteButton"
